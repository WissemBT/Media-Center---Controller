...
SOCKSIZE {\bfseries send\+To} (void const $\ast$buf, size\+\_\+t len, int flags, SOCKADDR const $\ast$to, socklen\+\_\+t addrlen)
...
SOCKSIZE {\bfseries receive\+From} (void $\ast$buf, size\+\_\+t len, int flags, SOCKADDR $\ast$from, socklen\+\_\+t $\ast$addrlen)
